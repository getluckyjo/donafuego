...
(function () {
  ...
  var RTD  = [0,0,2410560,0,937440,825096,825096,825096,825096,825096,353400,353400,353400,353400,353400,353400,825096,825096,825096];
  ...
  var CASH = [-114423,-688048,-1407751,-561960,-757720,-398842,337852,600999,853252,1144572,1970384,2086037,2148589,2299778,2342073,2397440,2139913,2472906,2670015];
  ...
  function renderRevenue() {
    ...
    var max = 2800000; // headroom above the Aug-26 opening order month (R2.46m)
    ...
    var at = svgEl('text', { x: ax + 14, y: y(2410560) + 4, 'font-size': 12.5, fill: C_GREEN, 'font-weight': 600 });
    at.textContent = 'Opening order · R2.41m';
    svg.appendChild(at);
  ...
  function renderCash() {
    ...
    [[2, CASH[2], 'Peak need −R1.41m · Aug 26', '#A00000'], [18, CASH[18], 'Dec 27 · R2.67m cash', C_GREEN]].forEach(function (a) {
